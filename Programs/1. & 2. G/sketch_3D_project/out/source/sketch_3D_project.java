...
public class sketch_3D_project extends PApplet {
...
int h = 1000;
float fly = 0;
float speedOffset = 0.0023f*scale;
float camX = 65, camY = 10000, camZ;
...
public void keyReleased() {
 if (key<256) {
  ...
  public void settings() {  size(1280, 720 ,P3D);  noSmooth(); }
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "sketch_3D_project" };
    if (passedArgs != null) {
